...
splat_center_ellipse = gs*vec3(0.25,0.50,0.5)
splat_sigma_x = 8.0
splat_sigma_y = 1.0
...
#	This is elliptical Gaussian
	create_pressure_modifier_elliptical_gaussian_with_multiplier(pressure_modification_elliptical_gaussian , splat_radius_x , splat_radius_y , splat_center_ellipse , splat_sigma_x , splat_sigma_y , multiplier = 4.53, lower_factor = 1.0, higher_factor = 1.0)
...
#		This is velocity correction
		...
		setWallBcs(flags=flags, vel=vel)
		splat_center_ellipse = (splat_center_ellipse)+(vec3(0.5,0.0,0.0))
	...
	timings.display()
	s.step()
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/december_4_und_5/5/horizontally_translating_positive_elliptical_gaussian/velocities/0.5_with_2_step_advection/%03d_dens.png' % t )
	gui.screenshot( '/media/tushar/TOSHIBA EXT/manta/build/pictures/december_4_5/5/horizontally_translating_positive_elliptical_gaussian/april_21/density/%03d.png' % t )
