...
#		This is velocity correction
		...
		setWallBcs(flags=flags, vel=vel)
		splat_center_ellipse.x = int(splat_center_ellipse.x+0.5)
		splat_center_ellipse.y = int(splat_center_ellipse.y+0.5)
		splat_center_ellipse.z = 1
		velocity_center = vel.get(splat_center_ellipse)
