...
splat_center_ellipse = gs*vec3(0.5,0.25,0.5)
splat_sigma_x = 8.0
splat_sigma_y = 1.0
...
#	This is elliptical Gaussian
	splat_center_ellipse = (splat_center_ellipse)+(vec3(0.0,0.5,0.0))
	create_pressure_modifier_elliptical_gaussian_with_multiplier(pressure_modification_elliptical_gaussian , splat_radius_x , splat_radius_y , splat_center_ellipse , splat_sigma_x , splat_sigma_y , multiplier = 6.0, lower_factor = 1.0, higher_factor = 1.0)
...
#		This is velocity correction
	...
	timings.display()
	s.step()
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/november_28/13_moving_elliptical_gaussians/positive/vertical/%03d_density.png' % t )
	gui.screenshot( '/media/tushar/TOSHIBA EXT/manta/build/pictures/december_4_5/5/vertically_translating_positive_elliptical_gaussian/3/density/%03d.png' % t )
