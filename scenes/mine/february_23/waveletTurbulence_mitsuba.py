...
for t in range(200):
	...
	xl_density.save('/media/tushar/TOSHIBA EXT/manta/vol_files/densityXl08_%04d.vol' % t)
#	xl_density.save('/home/tushar/manta_mikey_1/manta/build/pictures/february_23/6/densityXl08_%04d.vol' % t)
