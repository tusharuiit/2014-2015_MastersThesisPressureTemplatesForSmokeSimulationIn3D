...
#	time range of application of pressure modification
	...
	if ((t>=t1)and(t<t2)):
		...
		create_perlin_template_19(pressure_template_perlin,multiplier=12.0,res_x=gs_x,res_y=gs_y,time=t, x_factor=7.0, y_factor=7.0,time_steps=30,start_x=0.2,start_y=2.8)
...
#	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.0)
...
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_27/images/4/%03d_dens.png' % t )
