...
#	time range of application of pressure modification
	...
	if (t>=t1)and(t<t2):
		...
		chunk = d[1470*(t-1)+2:1470*(t-1+1)+2]
		chunk_left = []
		chunk_right = []
		...
		amplitude = sqrt(mean(square(chunk_right))) * 150.0 * 1.5
...
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_27/images/1/%03d.png' % t )
