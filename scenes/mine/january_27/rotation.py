...
#	time range of application of pressure modification
	...
	if ((t>=t1)and(t<t2)):
		...
		create_perlin_template_22(pressure_template_perlin,multiplier=12.0,res_x=gs_x,res_y=gs_y,time=t, x_factor=7.0, y_factor=21.0)
...
#		This is velocity correction
	...
	solvePressure3_part1(flags=flags, vel=vel, pressure=pressure, openBound='Y',max_iters = 750 )
...
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_30/images/1/%03d_dens.png' % t )
