...
#	time range of application of pressure modification
	...
	if ((t>=t1)and(t<t2)):
		if(t % 2 == 0):
			frequency_changer_x = 6.0
			frequency_changer_y = 18.0
		else:
			frequency_changer_y = 6.0
			frequency_changer_x = 18.0
		
		create_perlin_template_5(pressure_template_perlin,multiplier=12.0,res_x=gs_x,res_y=gs_y,frequency_changer_x=frequency_changer_x,frequency_changer_y=frequency_changer_y,time=t)
...
#	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.5)
	...
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_25/images/3/%03d_density_vel.png' % t )
