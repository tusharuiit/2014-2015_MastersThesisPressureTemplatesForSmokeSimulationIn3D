...
pressure_template_heart = s.create(RealGrid)

#This the boundary smoother
create_image_template(boundary_zero_smoother,multiplier=1.0,res_x=gs_x,res_y=gs_y)
create_image_template_heart(pressure_template_heart,multiplier=1.0,res_x=gs_x,res_y=gs_y)
...
#	Note that this function starting at t=5 is important
		create_perlin_template_12(pressure_template_perlin,multiplier=12.0,res_x=gs_x,res_y=gs_y,time=t)
...
#		This is velocity correction
	...
	elif (t>=t1)and(t<t2)and((t%6)>=5):
#		This is velocity correction
		solvePressure3_part2(flags=flags, vel=vel, pressure=pressure_template_heart)
		setWallBcs(flags=flags, vel=vel)
...
#	density.save('/home/tushar/manta_mikey_1/manta/build/pictures/january_11_12/vol_files/2d/den%04d.vol' % t)
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_17/images/9/%03d.png' % t )
