...
#	time range of application of pressure modification
	...
	if ((t>=t1)and(t<t2)):
		if((t%2) == 1):
			create_perlin_template_5(pressure_template_perlin,multiplier=12.0,res_x=gs_x,res_y=gs_y,frequency_changer_x=7,frequency_changer_y=21,time=t)
		elif((t%2) == 0):
			create_perlin_template_5(pressure_template_perlin,multiplier=12.0,res_x=gs_x,res_y=gs_y,frequency_changer_x=21,frequency_changer_y=7,time=t)
...
#	density.save('/home/tushar/manta_mikey_1/manta/build/pictures/january_11_12/vol_files/2d/den%04d.vol' % t)
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_17/images/3/%03d.png' % t )
