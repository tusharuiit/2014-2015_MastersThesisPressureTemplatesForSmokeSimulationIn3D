...
#		freq_value_scaled = (3.0/2500.0)*(freq_value)
		freq_value_scaled = (3.0/2500.0)*(freq_value) + 3.0
...
#	Note that this function starting at t=5 is important
		create_perlin_template_13(pressure_template_perlin,multiplier=10.0,res_x=gs_x,res_y=gs_y,ffrequency=freq_value_scaled,time=t)
...
#	density.save('/home/tushar/manta_mikey_1/manta/build/pictures/january_11_12/vol_files/2d/den%04d.vol' % t)
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_22/images/2/%03d.png' % t )
