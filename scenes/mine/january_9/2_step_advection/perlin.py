...
#	ADVECTION
	...
	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=vel, order=2, time_fraction = 0.0)
...
#	time range of application of pressure modification
	...
	if (t==(t2)):
		gui.pause()
	if (t>=t1)and(t<t2):
#		This is velocity correction WITH PRESSURE TEMPLATE
...
#	PPE
	...
	timings.display()
	s.step()
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_9/6/images/%03d.png' % t )
