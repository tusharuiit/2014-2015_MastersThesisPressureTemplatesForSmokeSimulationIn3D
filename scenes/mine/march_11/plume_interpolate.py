...
for t in range(gs_z):
	...
	if ((t>=t1)and(t<t2)):
		...
		create_perlin_template_26(pressure_template_perlin_x,multiplier=multiplier,res_x=gs_x,res_y=gs_y,res_z=gs_z,frequency_x=y_frequency_x,frequency_y=y_frequency_y,frequency_z=frequency_z,z=t,folder_templates_number=folder_templates_number)
