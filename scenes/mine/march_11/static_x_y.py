...
#		source.applyToGrid(grid=density, value=1)
	...
	if ((t>=t1)and(t<t2)):
		...
		create_perlin_template_26(pressure_template_perlin_y,multiplier=multiplier,res_x=gs_x,res_y=gs_y,res_z=gs_z,frequency_x=y_frequency_x,frequency_y=y_frequency_y,frequency_z=frequency_z,z=t,folder_templates_number=folder_templates_number)
		...
		pressure_template_perlin_x_y.multConst(0.5)
		pressure_template_perlin_x_y.mult(boundary_zero_smoother)
		print "pressure_template_perlin_x_y.getMaxValue() = ", pressure_template_perlin_x_y.getMaxValue()
