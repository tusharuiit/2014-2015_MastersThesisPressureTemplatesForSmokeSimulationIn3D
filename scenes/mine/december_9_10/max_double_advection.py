...
create_pressure_modifier_elliptical_gaussian_with_multiplier(pressure_modification_elliptical_gaussian , splat_radius_x , splat_radius_y , splat_center_ellipse , splat_sigma_x , splat_sigma_y , multiplier = 120.0, lower_factor = 1.0, higher_factor = 1.0)
...
for t in range(400):
	...
	fraction_divergencefree = 0.95
	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=vel, order=2,time_fraction = fraction_divergencefree)
...
#	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.5)    
	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=vel,     order=2, time_fraction = (1.0 - fraction_divergencefree))
	setWallBcs(flags=flags, vel=vel) 
	...
	timings.display()
	s.step()
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/december_9_10/stronger_EG_more_divergencefree/120/%03d_dens.png' % t )
