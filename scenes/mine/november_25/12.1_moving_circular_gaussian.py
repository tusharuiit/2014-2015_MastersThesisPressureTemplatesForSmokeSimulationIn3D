...
splat_center_ellipse = gs*vec3(0.25,0.5,0.5)
splat_sigma_x = 4.0
splat_sigma_y = 4.0
splat_radius_x = int((res*0.25) - 1.0)
...
#	This is elliptical Gaussian
	splat_center_ellipse = (splat_center_ellipse)+(vec3(0.3,0.0,0.0))
...
#		gui.pause()
	...
	if (t>t1)and(t<t2):
#	if (((t>t1)and(t<t2))or((t>t3)and(t<t4))or((t>t5)and(t<t6))):
...
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/november_27/circular_gaussian/with_pause/%03d_density.png' % t )
