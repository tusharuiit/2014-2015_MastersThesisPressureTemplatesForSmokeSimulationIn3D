...
#	This is inflow and/or outflow thingy being set
	setInflowBcs(vel, dire='x', value=vec3(0.5,0.0,0.0))
...
#		addBuoyancy(density=density, vel=vel, gravity=vec3(0,-4e-3,0), flags=flags)
	...
	solvePressure3_part1(flags=flags, vel=vel, pressure=pressure, openBound='X')
...
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/november_28/15_channel_flow/X/%03d_density.png' % t )
