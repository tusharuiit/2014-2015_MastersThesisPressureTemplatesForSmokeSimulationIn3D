...
#		if((t%25) < 5):
		if((random_number % 2 ) == 1):
			create_perlin_template_5(pressure_template_perlin,multiplier=18.0,res_x=gs_x,res_y=gs_y,frequency_changer_x=15,frequency_changer_y=45,time=t)
#		elif(((t%25)>12)and((t%25)<17)):
		elif((random_number % 2)==0):
			create_perlin_template_5(pressure_template_perlin,multiplier=18.0,res_x=gs_x,res_y=gs_y,frequency_changer_x=45,frequency_changer_y=15,time=t)
...
#	density.save('/home/tushar/manta_mikey_1/manta/build/pictures/january_11_12/vol_files/2d/den%04d.vol' % t)
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_16/15/%03d.png' % t )
