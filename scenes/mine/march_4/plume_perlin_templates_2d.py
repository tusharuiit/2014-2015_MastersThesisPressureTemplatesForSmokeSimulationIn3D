...
#		create_perlin_template_24(pressure_template_perlin,multiplier=8.0,res_x=gs_x,res_y=gs_y,time=t,start_x=5.0,start_y=15.0,time_steps=60)
		create_perlin_template_25(pressure_template_perlin_x,multiplier=1.0,res_x=gs_x,res_y=gs_y,time=t,frequency_x=7.0,frequency_y=21.0,sign_translate_x = -0.0, sign_translate_y = -0.0)
		create_perlin_template_25(pressure_template_perlin_y,multiplier=1.0,res_x=gs_x,res_y=gs_y,time=t,frequency_x=21.0,frequency_y=7.0,sign_translate_x = -0.0, sign_translate_y = -0.0)
...
#		apply_template_localized(flags=flags, vel=vel, pressure_template=pressure_template_perlin_x_y, density=density, density_threshold=0.01, density_based_gradient_scaling = 1)
		apply_template_vorticity_localized(flags=flags, vel=vel, pressure_template=pressure_template_perlin_x_y, density=density, density_threshold=0.01, vorticity_based_gradient_scaling = 1)
...
##	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.5)
	...
	timings.display()
	s.step()
	target_directory_name='/home/tushar/manta_mikey_1/manta/build/pictures/march_5/images/1/%03d.png'
