...
source = s.create(Cylinder, center=gs*vec3(0.5,0.5,0.5), radius=gs_x*0.48, z=gs*vec3(0, 0.48, 0))

# This is for elliptical gaussian
splat_center_ellipse = gs*vec3(0.5,0.5,0.5)
splat_sigma_x = 16.0
splat_sigma_y = 2.0
splat_radius_x = (gs_x*0.5) - 4.0
splat_radius_y = (gs_y*0.25) - 2.0
...
#	time range of application of pressure modification
	...
	setInflowBcs(vel, dire='y', value=vec3(0.0,0.0,0.0))
