...
for t in range(400):
	...
	solvePressure3_part1(flags=flags, vel=vel, pressure=pressure, openBound='Y',max_iters = 50)
...
#	time range of application of pressure modification
	...
	if ((t>=t1)and(t<t2)):
		...
		create_perlin_template_14(pressure_template_perlin,multiplier=12.0,res_x=gs_x,res_y=gs_y,time=t)
