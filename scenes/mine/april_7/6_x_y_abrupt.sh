...
cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/3_x_y_abrupt/density_strength_10

temp0=$(pwd)
temp1=$(ls)
temp2=($temp1)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/3_x_y_abrupt/density_strength_18

temp3=$(pwd)
temp4=$(ls)
temp5=($temp4)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/3_x_y_abrupt/template
...
cd /media/tushar/TOSHIBA\ EXT/Nils/today/montages/6_x_y_abrupt
