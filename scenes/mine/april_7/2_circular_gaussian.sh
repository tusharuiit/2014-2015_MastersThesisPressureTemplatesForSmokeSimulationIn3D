...
cd /media/tushar/TOSHIBA\ EXT/Nils/today/2_circular_gaussian/density

temp0=$(pwd)
temp1=$(ls)
temp2=($temp1)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/2_circular_gaussian/template

temp3=$(pwd)
temp4=$(ls)
temp5=($temp4)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/2_circular_gaussian/velocity

temp00=$(pwd)
temp11=$(ls)
temp22=($temp11)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/2_circular_gaussian/template_velocity

temp33=$(pwd)
temp44=$(ls)
temp55=($temp44)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/montages/2_circular_gaussian
