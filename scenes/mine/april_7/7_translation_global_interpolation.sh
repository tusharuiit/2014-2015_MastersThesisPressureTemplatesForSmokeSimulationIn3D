...
cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/4_translation/density

temp0=$(pwd)
temp1=$(ls)
temp2=($temp1)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/5_global_interpolation/density

temp3=$(pwd)
temp4=$(ls)
temp5=($temp4)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/4_translation/template

temp00=$(pwd)
temp11=$(ls)
temp22=($temp11)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/5_global_interpolation/template

temp33=$(pwd)
temp44=$(ls)
temp55=($temp44)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/montages/7_translation_global_interpolation
