...
cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/7_global_rotation/template
temp0=$(pwd)
temp1=$(ls)
temp2=($temp1)
...
convert "$temp7" -resize 256x256! "$temp7"
done


cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/7_global_rotation/density
...
cd /media/tushar/TOSHIBA\ EXT/Nils/today/montages/10_global_rotation
