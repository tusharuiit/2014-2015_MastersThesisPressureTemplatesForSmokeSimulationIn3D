...
cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/2_elliptical_perlin/density_x_biased

temp0=$(pwd)
temp1=$(ls)
temp2=($temp1)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/2_elliptical_perlin/density_y_biased

temp3=$(pwd)
temp4=$(ls)
temp5=($temp4)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/2_elliptical_perlin/template
...
cd /media/tushar/TOSHIBA\ EXT/Nils/today/montages/5_elliptical_abrupt
