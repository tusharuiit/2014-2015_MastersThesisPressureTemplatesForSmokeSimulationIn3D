...
cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/6_local_interpolation/density

temp0=$(pwd)
temp1=$(ls)
temp2=($temp1)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/8_sinusoidal_warping/density

temp3=$(pwd)
temp4=$(ls)
temp5=($temp4)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/6_local_interpolation/template/1

temp00=$(pwd)
temp11=$(ls)
temp22=($temp11)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/4_perlin/8_sinusoidal_warping/template

temp33=$(pwd)
temp44=$(ls)
temp55=($temp44)

cd /media/tushar/TOSHIBA\ EXT/Nils/today/montages/8_local_interpolation_sine_warping
