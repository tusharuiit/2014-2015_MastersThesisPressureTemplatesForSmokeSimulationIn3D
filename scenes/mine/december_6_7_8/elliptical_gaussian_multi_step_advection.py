...
for t in range(400):
	...
	for times in range(advectiontimes):
		advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=vel, order=2,time_fraction = (0.5/advectiontimes))
...
#		This is velocity correction
	...
	timings.display()
	s.step()
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/december_6_7_8/multi_step_advection/elliptical_gaussian/10/%03d_dens.png' % t )
