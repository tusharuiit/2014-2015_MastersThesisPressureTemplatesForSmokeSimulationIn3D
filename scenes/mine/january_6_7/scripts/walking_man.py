...
for t in range(last_time_step):
	...
	create_image_template_varying(pressure_template_image,t,multiplier=1.0,res_x=gs_x,res_y=gs_y)
...
#		fo.close()
	...
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_6_7/1/images/%03d.png' % t )
