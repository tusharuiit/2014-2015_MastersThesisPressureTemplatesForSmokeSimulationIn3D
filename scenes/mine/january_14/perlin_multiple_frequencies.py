...
create_perlin_template_3(pressure_template_perlin,multiplier=8.0,res_x=gs_x,res_y=gs_y,frequency_changer=0,levels=5)
...
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_14/videos/3/velocity/%03d.png' % t )
