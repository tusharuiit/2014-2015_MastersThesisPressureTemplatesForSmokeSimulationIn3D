...
#	time range of application of pressure modification
	...
	if (t>t1)and(t<t2):
		modify_pressure_constant(pressure,pressure_modification_elliptical_gaussian,multiplier=((float(m)*t)+c))
	...
	s.step()
	gui.screenshot( './pictures/november_3/4.3/%03d_density.png' % t )
