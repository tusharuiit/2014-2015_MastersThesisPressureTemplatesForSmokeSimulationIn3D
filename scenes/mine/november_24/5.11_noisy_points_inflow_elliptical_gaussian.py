...
#source = s.create(Cylinder, center=gs*vec3(0.5,0.3,0.5), radius=res*0.14, z=gs*vec3(0, 0.02, 0))
...
#	This is inflow and/or outflow thingy being set
	setInflowBcs(vel, dire='yY', value=vec3(0.0,0.25,0.0))
...
#	time range of application of pressure modification
	...
	s.step()
	gui.screenshot( './pictures/november_3/5.11/%03d_density.png' % t )
