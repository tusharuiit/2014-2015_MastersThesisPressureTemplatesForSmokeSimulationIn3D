...
#		In quadratic gradient, the lower factor has to be 0.0
		create_pressure_modifier_elliptical_gaussian_with_multiplier_and_quadratic_gradient(pressure_modification_elliptical_gaussian , splat_radius_x , splat_radius_y , splat_center_ellipse , splat_sigma_x , splat_sigma_y , multiplier = 8.0,lower_factor = 0.0, higher_factor = 2.0)
...
#	gui.screenshot( './pictures/november_3/3/density_3steps/%03d_end_density.png' % t )
	gui.screenshot( './pictures/november_24/gradient_quadratic_elliptical/%03d_density.png' % t )
