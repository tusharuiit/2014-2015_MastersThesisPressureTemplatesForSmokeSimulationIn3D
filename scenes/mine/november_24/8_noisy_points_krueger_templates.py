...
im = Image.open("/home/tushar/manta_mikey_1/manta/scenes/mine/november_24/templates_krueger/november_25/star17.png")
...
#		gui.screenshot( './pictures/november_3/3/density_3steps/%03d_after_pressure_modify_density.png' % t )
	...
	s.step()
	gui.screenshot( './pictures/november_24/star17/%03d_end_density.png' % t )
