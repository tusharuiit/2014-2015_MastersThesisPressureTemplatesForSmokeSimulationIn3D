...
#		This is elliptical Gaussian
		create_pressure_modifier_elliptical_gaussian_with_multiplier_and_cubic_gradient(pressure_modification_elliptical_gaussian , splat_radius_x , splat_radius_y , splat_center_ellipse , splat_sigma_x , splat_sigma_y , multiplier = 6.0,lower_factor = 0.0, higher_factor = 4.0)
...
#	gui.screenshot( './pictures/november_3/3/density_3steps/%03d_end_density.png' % t )
	gui.screenshot( './pictures/november_24/gradient_cubic_elliptical/%03d_density.png' % t )
