...
#	This is elliptical Gaussian
	create_pressure_modifier_elliptical_gaussian_with_multiplier(pressure_modification_elliptical_gaussian , splat_radius_x , splat_radius_y , splat_center_ellipse , splat_sigma_x , splat_sigma_y , multiplier = 3.0, lower_factor = 1.0, higher_factor = 1.0)
...
#	time range of application of pressure modification
	...
	if ((t>t1)and(t<t2))or((t>t3)and(t<t4)):
...
#	gui.screenshot( './pictures/november_3/3/density_3steps/%03d_end_density.png' % t )
	gui.screenshot( './pictures/november_24/with_pause/%03d_density.png' % t )
