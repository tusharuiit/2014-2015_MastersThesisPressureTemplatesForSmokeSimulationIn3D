...
create_pressure_modifier_elliptical_gaussian_with_multiplier(pressure_modification_elliptical_gaussian , splat_radius_x , splat_radius_y , splat_center_ellipse , splat_sigma_x , splat_sigma_y , multiplier = 1.0, lower_factor = 1.0, higher_factor = 1.0)
...
#	This is inflow and/or outflow thingy being set
	setInflowBcs(vel, dire='y', value=vec3(0.0,0.5,0.0))
...
#		This is velocity correction
	...
	s.step()
#	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/november_28/15_channel_flow/%03d_density.png' % t )
