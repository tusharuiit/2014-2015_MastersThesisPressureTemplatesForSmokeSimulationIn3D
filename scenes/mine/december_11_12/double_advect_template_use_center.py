...
for t in range(400):
	...
	setInflowBcs(vel, dire='y', value=vec3(0.0,0.1,0.0))
...
#	This is elliptical Gaussian
	create_pressure_modifier_elliptical_gaussian_with_multiplier(pressure_modification_elliptical_gaussian , splat_radius_x , splat_radius_y , splat_center_ellipse_rounded , splat_sigma_x , splat_sigma_y , multiplier = 12.0, lower_factor = 1.0, higher_factor = 1.0)
...
#		This is velocity correction
	...
	timings.display()
	s.step()
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/december_11_12/center_grid/inflow/0.1/%03d_dens.png' % t )
