...
density_based_gradient_scaling=int(sys.argv[8])
vorticity_based_gradient_scaling=int(sys.argv[9])
run_count=(sys.argv[10])
...
#		apply_template_localized(flags=flags, vel=vel, pressure_template=pressure_template_perlin_x_y, density=density, density_threshold=density_threshold, density_based_gradient_scaling=density_based_gradient_scaling)
		apply_template_vorticity_localized(flags=flags, vel=vel, pressure_template=pressure_template_perlin_x_y, density=density, density_threshold=density_threshold, vorticity_based_gradient_scaling=vorticity_based_gradient_scaling)
