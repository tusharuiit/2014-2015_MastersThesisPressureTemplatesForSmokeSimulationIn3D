...
create_image_template_heart(pressure_template_heart,multiplier=4.0,res_x=gs_x,res_y=gs_y)
...
#	time range of application of pressure modification
	...
	if (t==(t2)):
		gui.pause()
	if (t>=t1)and(t<t2)and((t%10)<6):
#	This is for perlin noise template
#	It has a maximum value of multiplier and minimum value of 0.0
		create_perlin_template_12(pressure_template_perlin,multiplier=10.0,res_x=gs_x,res_y=gs_y,time=t)
...
#	density.save('/home/tushar/manta_mikey_1/manta/build/pictures/january_11_12/vol_files/2d/den%04d.vol' % t)
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_20/1/%03d.png' % t )
