...
#	time range of application of pressure modification
	...
	if ((t>=t1)and(t<t2)):
		...
		create_perlin_template_17(pressure_template_perlin,multiplier=12.0,res_x=gs_x,res_y=gs_y,time=t,start_x=10.0,start_y=30.0,time_steps=60)
...
#	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.5)
	...
	timings.display()
	s.step()
	gui.screenshot( '/home/tushar/manta_mikey_1/manta/build/pictures/january_25/images/8/%03d.png' % t )
