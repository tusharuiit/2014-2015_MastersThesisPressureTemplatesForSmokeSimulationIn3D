...
angle1 = int((sys.argv[10]))
angle2 = int((sys.argv[11]))
angle3 = int((sys.argv[12]))
angle4 = int((sys.argv[13]))
angle5 = int((sys.argv[14]))
angle6 = int((sys.argv[15]))
angle7 = int((sys.argv[16]))

sign1 = int((sys.argv[17]))
sign2 = int((sys.argv[18]))
sign3 = int((sys.argv[19]))
sign4 = int((sys.argv[20]))
sign5 = int((sys.argv[21]))
sign6 = int((sys.argv[22]))
sign7 = int((sys.argv[23]))
...
simulation_directory_name = "/media/tushar/B19D-ABF3/latex1/6_3D_april_11/12_pressure_template_rotate/" + folder_simulation_number
...
#		densityInflow(flags=flags, density=density, noise=noise, shape=source, scale=1, sigma=0.5)
	...
	if ( (t>=t1) and (t<=t2) and ((t % every_time_step == 0)) ):
		...
		create_perlin_template_rotate_3D_kernel ( pressure_template_perlin_x, multiplier=multiplier, res_x=gs_x, res_y=gs_y, res_z=gs_z, time=t, frequency_x=x_frequency_x, frequency_y=x_frequency_y, frequency_z=10, every_time_step = every_time_step, angle = angle, sign = sign )
