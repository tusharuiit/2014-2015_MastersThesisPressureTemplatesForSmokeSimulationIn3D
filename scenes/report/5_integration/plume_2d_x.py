...
simulation_directory_name = "/media/tushar/TOSHIBA\ EXT/latex/6_integration/density/" + folder_simulation_number
templates_directory_name = "/media/tushar/TOSHIBA\ EXT/latex/6_integration/template/" + folder_templates_number
