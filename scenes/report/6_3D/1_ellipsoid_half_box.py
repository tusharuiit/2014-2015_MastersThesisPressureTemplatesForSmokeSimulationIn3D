...
source = s.create(Box, p0=gs*vec3(0.35,0.25,0.25), p1=gs*vec3(0.65,0.75,0.75))
...
n = 0.0
p = 0.0
a = 1.0/(2.0 * pow(13.5,2.0))
b = 1.0/(2.0 * pow(2.30,2.0))
c = 1.0/(2.0 * pow(2.30,2.0))
...
create_ellipsoidal_gaussian_3D(pressure_modification, radius_x, radius_y, radius_z, center_ellipsoid, a, b, c, m, n, p , multiplier = 4.75)
...
for t in range(400):
	...
	density.save('/media/tushar/TOSHIBA EXT/april_19/vol/1_ellipsoidal_gaussian/%04d.vol' % t)
...
#	This is velocity correction
	...
	timings.display()
	s.step()
	gui.screenshot( '/media/tushar/TOSHIBA EXT/latex/7_3D/1_ellipsoidal_gaussian/%03d.png' % t )
