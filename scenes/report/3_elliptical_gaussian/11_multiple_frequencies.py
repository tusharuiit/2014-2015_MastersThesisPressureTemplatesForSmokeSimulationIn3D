...
#	It has a maximum value of multiplier and minimum value of 0.0
		create_perlin_template_multiple_frequencies ( pressure_modification = pressure_template, multiplier = 10.0, res_x = gs_x, res_y = gs_y, levels = 3, time = t , x_factor = 4, y_factor = 16, folder_templates_number = str(2), persistence = 1.414 )
...
#	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.5)
	...
	timings.display()
	s.step()
#	gui.screenshot( '/media/tushar/TOSHIBA EXT/latex/4_Perlin/7_global_rotation/density/%03d.png' % t )
