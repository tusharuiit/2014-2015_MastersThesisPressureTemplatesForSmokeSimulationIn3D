...
#	It has a maximum value of multiplier and minimum value of 0.0
		create_perlin_template_global_interpolation_x_y ( pressure_template, multiplier = 10.0, res_x = gs_x, res_y = gs_y, time = t , start_x = 8, start_y = 32, time_steps = 30 )
...
#	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.5)
	...
	timings.display()
	s.step()
	gui.screenshot( '/media/tushar/TOSHIBA EXT/latex/4_Perlin/5_global_interpolation/density/%03d.png' % t )
