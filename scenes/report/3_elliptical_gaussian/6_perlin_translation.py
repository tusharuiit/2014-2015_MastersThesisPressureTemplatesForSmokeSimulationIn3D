...
#	It has a maximum value of multiplier and minimum value of 0.0
		create_perlin_template_translation ( pressure_template, multiplier = 10.0, res_x = gs_x, res_y = gs_y, frequency_changer_1 = 7, frequency_changer_2 = 25, time = t )
...
#	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.5)
	...
	timings.display()
	s.step()
	gui.screenshot( '/media/tushar/TOSHIBA EXT/latex/4_Perlin/4_translation/density/%03d.png' % t )
