...
create_static_perlin_template_general ( pressure_modification = pressure_template_perlin, multiplier = -9.0, res_x = gs_x, res_y = gs_y, frequency_changer_x = 7, frequency_changer_y = 21, time = 1 )
...
#	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.5)
	...
	timings.display()
	s.step()
#	gui.screenshot( '/media/tushar/TOSHIBA EXT/latex/4_Perlin/2_elliptical_perlin/density/%03d.png' % t )
