...
#	This is for perlin noise template
		create_perlin_template_local_interpolation_x_y ( pressure_template_perlin_x, multiplier=multiplier, res_x=gs_x, res_y=gs_y, frequency_x = frequency_x_bias_x, frequency_y = frequency_x_bias_y, folder_templates_number=folder_templates_number, time =t)
		create_perlin_template_local_interpolation_x_y ( pressure_template_perlin_y, multiplier=multiplier, res_x=gs_x, res_y=gs_y, frequency_x = frequency_y_bias_x, frequency_y = frequency_y_bias_y, folder_templates_number=folder_templates_number, time =t)
		print_perlin_template_local_interpolation_x_y ( res_x=gs_x, res_y=gs_y, frequency_x_1 = frequency_y_bias_x, frequency_y_1 = frequency_y_bias_y, frequency_x_2 = frequency_x_bias_x, frequency_y_2 = frequency_x_bias_y, folder_templates_number=folder_templates_number, time =t, time_steps = time_steps )
...
#	advectSemiLagrange_time_fraction(flags=flags, vel=vel, grid=density, order=2, time_fraction = 0.5)
	...
	timings.display()
	s.step()
	gui.screenshot( '/media/tushar/TOSHIBA EXT/latex/4_Perlin/6_local_interpolation/density/%03d.png' % t )
