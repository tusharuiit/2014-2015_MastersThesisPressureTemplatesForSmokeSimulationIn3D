...
public:
	...
	PYTHON void applyRNG_NoiseToGrid(GridBase* grid, FlagGrid* respectFlags=0);
	PYTHON void applyRNG_binary_NoiseToGrid(GridBase* grid, FlagGrid* respectFlags=0);
	PYTHON void applyRNG_binary_NoiseToGrid_seeded(GridBase* grid, FlagGrid* respectFlags=0 );
	PYTHON void applyRNG_binary_NoiseToGrid_seeded_3D(GridBase* grid, FlagGrid* respectFlags=0 );
	PYTHON void applyRNG_binary_NoiseToGrid_seeded_3D_kernel(GridBase* grid, FlagGrid* respectFlags=0 );
	PYTHON void applyRNG_binary_NoiseToGrid_seeded_3D_kernel_trial(GridBase* grid, FlagGrid* respectFlags=0 );
	PYTHON void applydensity_at_pointToGrid(GridBase* grid, FlagGrid* respectFlags=0,Vec3 position = Vec3(40,32,0.5));
